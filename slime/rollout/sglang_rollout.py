...
def generate_rollout(
    ...
    """
    # Check for NeMo Gym mode
    if getattr(args, "use_nemo_gym", False):
        from slime.rollout.nemo_gym_rollout import generate_nemo_gym_rollout
        return generate_nemo_gym_rollout(args, rollout_id, data_source, evaluation)
